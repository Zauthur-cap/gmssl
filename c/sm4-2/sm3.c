...
// 消息扩展，消息Bi -> W
void gm_sm3_BiToW(const unsigned char * Bi, unsigned int * W) {
    int i;
    unsigned int tmp;
...
// w 扩展算法
void gm_sm3_WToW1(const unsigned int * W, unsigned int * W1) {
    int i;
...
// 压缩算法
void gm_sm3_CF(const unsigned int * W, const unsigned int * W1, gm_sm3_context * ctx)
{
    unsigned int SS1;
    unsigned int SS2;
    unsigned int TT1;
...
// 压缩算法
void gm_sm3_compress(gm_sm3_context * ctx) {
    unsigned int W[68];
    unsigned int W1[64];
