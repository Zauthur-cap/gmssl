 ...
 */
inline void gm_sm2_exch_init(gm_sm2_exch_context * ctx, gm_bn_t private_key, const gm_point_t * public_key, 
  unsigned char isInitiator, const unsigned char * id_bytes, unsigned int idLen, unsigned char output[64]);

inline void gm_sm2_exch_init_for_test(gm_sm2_exch_context * ctx, gm_bn_t private_key, const gm_point_t * public_key, 
 ...
 */
inline void gm_sm2_exch_calculate(gm_sm2_exch_context * ctx, const unsigned char * peer_p, const unsigned char * peer_r, 
 ...
 */
inline int gm_sm2_sign_init(gm_sm2_context * ctx, const unsigned char * key, unsigned int kLen, 
 ...
 * @param iLen 待处理数据长度
 */
inline void gm_sm2_sign_update(gm_sm2_context * ctx, const unsigned char * input, unsigned int iLen);
 ...
 */
inline int gm_sm2_sign_done(gm_sm2_context * ctx, unsigned char sig[64]);

inline int gm_sm2_sign_done_for_test(gm_sm2_context * ctx, unsigned char sig[64], const gm_bn_t testKey);
 ...
 * @return 1返回成功，否则为密钥非法
 */
inline int gm_sm2_crypt_init(gm_sm2_context * ctx, const unsigned char * key, unsigned int kLen, int forEncryption, unsigned char c1[65]);
 ...
 * @return 1返回成功，否则为密钥非法
 */
inline int gm_sm2_crypt_init_for_test(gm_sm2_context * ctx, const unsigned char * key, unsigned int kLen, 
 ...
 * @return 返回已处理的数据长度
 */
inline int gm_sm2_crypt_update(gm_sm2_context * ctx, const unsigned char * input, unsigned int iLen, unsigned char * output);
 ...
 * @return 返回已处理的数据长度
 */
inline int gm_sm2_crypt_done(gm_sm2_context * ctx, unsigned char * output, unsigned char c3[32]);
 ...
 * @param output 输出缓冲区
 */
inline void gm_sm2_compute_z_digest(const unsigned char * id_bytes, unsigned int idLen, const gm_point_t * pub_key,
 ...
 * @param output 输出缓冲区
 */
inline void gm_sm2_compute_msg_hash(const unsigned char * input, unsigned iLen,
 ...
 */
inline void gm_sm2_gen_keypair(gm_bn_t private_key, gm_point_t * public_key);
